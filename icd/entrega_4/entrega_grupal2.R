...
arbolado <- read.csv("/home/datascience/Descargas/arbolado-publico-lineal-2017-2018.csv")
...
#   labs(title = 'Jacarandas por comuna', x='Comuna', y='Cantidad') #+
# #  coord_cartesian(ylim=c(0,40000))
# 
# ggplot(comunas, aes(x=factor(comuna), fill = factor(comuna))) + geom_bar() +
  # labs(title = 'Arboles por comuna', x='Comuna', y='Cantidad')
...
#   labs(title='Promedio de ancho de aceras por comuna', x='Comuna', y='Ancho')
# grafico
# 
# 
...
#filtro jacarandàs en av Pueyrredón 
...
# #cantidad de arboles en av. pueryrredón al 1000
